...
\section{Summary}
\vspace{-2pt}
\resumeItem{Problem solver with experience in developing low latency, highly scalable, fault-tolerant, distributed backend services and evolving the architecture for performance and scalability.Experience of Object-Oriented Programming, Object-Oriented Design, Messaging, Event Streaming,
Data Structures and Algorithms, Prevalent Design Patterns, Caching,
NoSQL, RDBMS.}
\newline
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
          \resumeItem{Central Logging Pipeline}
          {Designed a central logger service for all external microservices metric logging. This service is made agnostic and easy to integrate with all other microservices.}
          \resumeItem{B2C Service}{Developed a light weight B2C service for all the clients who are mapped with B2C. It has business logic for booking flow of B2C clients and handling clients on Yatra's website. }
          \resumeItem{Dedupe Pipeline}{Working on improving the existing Dedup content pipeline for Auto Suggest Microservice.}
          \newline
      \resumeItemListEnd
\vspace{2pt}
    \resumeSubheading
        ...
        \vspace{0pt}
        \textbf{Impact:}\text{~Reduced ETM Movement cost by 30\%}
        \newline
		\resumeItemListEnd
\vspace{2pt}
