  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{Vidhik Sewa App}{COVID19 helpline where needy people in Delhi can request government for basic services like Food, Shelter, etc. This was developed in a Hackathon event at Yatra.}
          ...
          {Designed a central logger service for external microservices metric logging. This service is made agnostic and easy to integrate with all other microservices.}
          \resumeItem{B2C Service}{Working on developing a light weight B2C service. This service does the heavy lifting of booking flow. Through this service we aim to upgrade a fat legacy service and improve its performance and maintenance.}
