  ...
  \resumeSubheading
    ...
    %\textbf{Developing low latency and highly scalable distributed backend services for Buyers Platform.}
        ...
        \resumeItem{Buyers Platform}
          {Developing highly available and scalable distributed backend services for Buyers Platform. My team owns services like Checkout, Cart Service, Post Order Management, Order Payment Management Service, Order Management Service, Promotions, Payments and Snapdeal web and mobile site.}
        ...
        \resumeItem {Order Payment Management Service} {Working on introducing multiple modes of payment for refund of order in case of COD. Thus making the refunds quick and improving customer experience.}.
        \newline
		\resumeItemListEnd
\vspace{2pt}
