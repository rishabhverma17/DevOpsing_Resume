...
\section{Experience}
  ...
  \resumeSubheading{Microsoft}{Noida, India}
    ...
    \resumeItemListStart
          \resumeItem{C\Plus E SPS SPARK}{Wroking in the Accounts team of SPS Spark Org}
          \resumeItem{AAD Graph Migration}{Migrated Our Service from AAD Graph to MS Graph with no bugs.}
          \resumeItem{Migrated from EUA to EUAM}{Migrated PrOSE service from EUA to EUAM for authorization and roles without any downtime. }
          \resumeItem{Surface Program}{Worked on Post enrollment part of Surface Partner On boarding to Partner Center.}
          \newline
      \resumeItemListEnd
  \resumeSubheading
